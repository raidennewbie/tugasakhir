        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    {{--  --}}
                    <li class="menu-item {{ Request::is('guru/beranda') ? 'active' : '' }}">
                        <a href="{{ route('guru.beranda') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Beranda</div>
                        </a>
                    </li>

                    <li class="menu-item {{ Request::is('guru/jadwal*') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ Request::is('guru/absensi*') ? 'active' : '' }}">
                        <a href="{{ route('guru.absensi.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-detail"></i>
                            <div data-i18n="Analytics">Data Absensi</div>
                        </a>
                    </li>
