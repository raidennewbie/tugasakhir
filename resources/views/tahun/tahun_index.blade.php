...
@section('container')
    ...
    <div class="card">
        <div class="app-brand mb-1 p-2 m-2">
            <h4 class="demo text-body">Data Tahun Ajaran</h4>
        </div>
        {{-- tambah berhasil --}}
    ...
    @endif
        ...
        {{-- tambah --}}
        <div class="card-body">
            <a href="{{ route('admin.tahunajar.create') }}" class="btn btn-primary btn-sm">TAMBAH</a>
        </div>
        {{--  --}}
        ...
        {{-- <div class="col-md-6">
            <form action="/admin/kelas" method="GET">
                <div class="input-group mb-1 p-2 m-10">
                    <input type="text" class="form-control" placeholder="Cari Kelas" name="query" value="{{ request('query') }}">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    {{-- edit --}}
                                    <a class="dropdown-item" href="{{ route('admin.tahunajar.edit', $kelas->id) }}">
                                        <i class="bx bx-edit-alt me-1 btn btn-warning btn-sm"></i>Edit</a>
                                    {{--  --}}

                                    {{-- hapus --}}
                                    <form action="{{ route('admin.tahunajar.destroy', $kelas->id) }}" method="POST"
                                        class="d-inline">
                                        @method('delete')
                                        @csrf
