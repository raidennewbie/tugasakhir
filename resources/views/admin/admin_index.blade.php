...
@section('container')
    ...
    <div class="card">
        <div class="app-brand mb-1 p-2 m-2">
            <h4 class="demo text-body">Data Pengguna</h4>
        </div>
        {{-- tambah berhasil --}}
        ...
        <div class="col-md-6">
            <form action="/admin/user" method="GET">
                <div class="input-group mb-1 p-2 m-10">
                    <input type="text" class="form-control" placeholder="Cari Pengguna" name="query" value="{{ request('query') }}">
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    {{-- edit --}}
                                    <a class="dropdown-item" href="{{ route('admin.user.edit', $pengguna->id) }}">
